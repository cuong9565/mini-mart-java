...
public class pnSupplier extends JPanel {
    ...
    JComboBox<String>cbSearch = new MyJComboBox<>(new String[]{"Tất cả"}, 12);
    ...
    public pnSupplier(JFrame frame) {
        ...
        btnRefresh.setBounds(855,29,100,40);
        tfSearch.setBounds(645, 29, 200, 40);
        cbSearch.setBounds(475, 29, 150, 40);
